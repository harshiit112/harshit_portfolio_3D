...
export const Particles = ({
  ...
  // Move and memoize rgb here so it's declared before usage
  ...
  const drawCircle = useCallback(
    (circle, update = false) => {
      if (context.current) {
        ...
        // Reset transform after drawing this circle
  ...
  const initCanvas = useCallback(() => {
    resizeCanvas();
    drawParticles();
  }, []); // No dependencies needed here because used functions handle them
